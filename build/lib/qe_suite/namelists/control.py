...
class Control:
  ...
  tstress= None; tprnfor= None;	dt= None;
  outdir= None; wfcdir= None; prefix= None;
  max_seconds= None; etot_conv_thr= None; 
  forc_conv_thr= None; disk_io= None; pseudo_dir= None; 
  tefield= None; dipfield=None; lelfield=None;
 ...
 #   self.options = option[target];
#    print("I am in control", option[Target.default])

...
class Calculation():
    ...
    def set_atomic_species(self, value):
        return 
        #self.atomic_species.set_card("",value);
    ...
    def set_cell_parameters(self, option, value):
        ...
        # self.set_cell_params.set_card(option,value);

...
for s in systs:
    ...
    structure=  ase.Atoms( positions=(positions), symbols=symbols, cell=cell);
    structures.append(structure);

#Find the most similar supercell structures within a strain tolerance
min_scell, min_diff,min_ds = vdw.get_vdw_cell( *structures, max_strain=0.1, strain_cell="a", max_size=30 )
